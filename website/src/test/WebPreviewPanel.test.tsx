...
describe('WebPreviewPanel', () => {
  ...
  // dashboard's own CSP does. The card has to name that blocker, or a reader is
  // sent into a mixed-content investigation for a frame-src problem (#10696).
  it('blames the dashboard policy, not the browser, for a *.localhost refusal', () => {
    ...
    try {
      ...
      expect(reason).toHaveTextContent(/content security policy/)
