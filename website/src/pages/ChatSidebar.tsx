      ...
      },
      {
        ...
        build: () => (
          ...
          >
            ...
            <span className="truncate"><span className="font-medium" style={{ color: 'var(--warn)' }}>{i18nT('pages.chatSidebar.loop_waiting_on_you')}</span><span className="text-muted"> · {goalLoop ? goalLoopLabel : monitorLabel}</span></span>
          </div>
        ),
      },
      {
